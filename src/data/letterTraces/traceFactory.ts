...
const LETTER_PATHS: Record<string, DrawCommand[]> = {
  ...
  n: [
    ...
    { type: 'L', x: 20, y: 118 },
    { type: 'M', x: 20, y: 56 },
    { type: 'C', x1: 32, y1: 38, x2: 52, y2: 34, x: 66, y: 48 },
    { type: 'C', x1: 78, y1: 60, x2: 80, y2: 84, x: 80, y: 118 },
  ],
  o: [{ type: 'M', x: 50, y: 36 }, { type: 'C', x1: 8, y1: 36, x2: 8, y2: 118, x: 50, y: 118 }, { type: 'C', x1: 92, y1: 118, x2: 92, y2: 36, x: 50, y: 36 }],
  p: [
    // Comic Sans-style lowercase p: trace the long stem top-to-bottom,
    // then return to the top to draw the rounded bowl.
    { type: 'M', x: 22, y: 42 },
    { type: 'L', x: 22, y: 144 },
    { type: 'M', x: 22, y: 44 },
    { type: 'C', x1: 46, y1: 28, x2: 82, y2: 36, x: 86, y: 68 },
    { type: 'C', x1: 90, y1: 100, x2: 58, y2: 120, x: 22, y: 104 },
  ],
  q: [
  ...
  r: [
    ...
    // downward, then return near the top for the short rounded shoulder.
    { type: 'M', x: 22, y: 42 },
    { type: 'L', x: 22, y: 118 },
    { type: 'L', x: 22, y: 58 },
    { type: 'C', x1: 34, y1: 40, x2: 52, y2: 36, x: 66, y: 44 },
    { type: 'C', x1: 74, y1: 48, x2: 78, y2: 56, x: 80, y: 64 },
  ],
...
Object.assign(LETTER_PATHS, {
  ...
  P: [
    ...
    { type: 'L', x: 22, y: 122 },
    { type: 'M', x: 22, y: 20 },
    { type: 'C', x1: 52, y1: 8, x2: 86, y2: 22, x: 84, y: 52 },
    { type: 'C', x1: 82, y1: 78, x2: 50, y2: 84, x: 22, y: 70 },
  ],
